...
if not os.path.exists(os.path.join(PROJECT_ROOT, "data/metalda/epoch")):
    os.makedirs(os.path.join(PROJECT_ROOT, "data/metalda/epoch"))

# Drop articles missing the institution
corona_df_institution = corona_df.dropna(subset=['authors_institutions'])

corona_df_institution.to_csv(os.path.join(PROJECT_ROOT, "data/metalda/institution/papers.csv"),
                 sep="\t",
                 header=False,
                 index=False,
...
corona_df_epoch.to_csv(os.path.join(PROJECT_ROOT, "data/metalda/epoch/papers.csv"),
                 sep="\t",
                 header=False,
                 index=False,
...
corona_df_epoch_institution.to_csv(os.path.join(PROJECT_ROOT, "data/metalda/papers.csv"),
                 sep="\t",
                 header=False,
                 index=False,
